...
def save_to_vtk(vertices, xyz, elements, u_pred_, u_exact_):
    ...
    interpolated_u_pred = griddata(points=xyz, values=u_pred, xi=vertices, method='nearest')
    interpolated_u_exact = griddata(points=xyz, values=u_exact, xi=vertices, method='nearest')
...
#
#     if epoch % 100 == 0:
#         torch.save(fno.state_dict(), f'fno_model.pth')
