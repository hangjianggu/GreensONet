...
def F(x):
    f_file = os.path.join('../../data/stokes/train_data', f'res16.vtu')
...
def U_exact(x):
    u_exact_file = os.path.join('../../data/stokes/train_data', f'res16.vtu')
...
def main():
    ...
    save_to_vtk(vertices, elements, x, u_pred_, boundary_u_pred_, u_exact)
