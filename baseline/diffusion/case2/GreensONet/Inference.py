...
if __name__ == '__main__':
    ...
    args.boundary_mesh_path = '../../../../mesh/diffusion/pipe_v2_boundary.mphtxt'
    ...
    args.problem = DiffusionReaction('../../../../data/diffusion/case2/test_data')
