...
class Trainer(object):
    ...
    def train_block(self, k):
        ...
        self.lr_scheduler = StepLR(self.optimizer_Adam, step_size=300, gamma=0.7)
...
if __name__ == '__main__':
    ...
    args.mesh_path = '../../../../mesh/diffusion/heat_sink_v2_domain.mphtxt'
    args.boundary_mesh_path = '../../../../mesh/diffusion/heat_sink_v2_boundary.mphtxt'
